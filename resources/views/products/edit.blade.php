...
@if ($errors->any())
    <div class="alert alert-danger">
        <strong>Whoops!</strong> Todos los campos requeridos. <br><br>
        <ul>
    ...
    @method('PUT')
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <textarea class="form-control" style="height:150px" name="description" placeholder="Descripción" >{{$product->description}}</textarea>
            </div>
        </div>
